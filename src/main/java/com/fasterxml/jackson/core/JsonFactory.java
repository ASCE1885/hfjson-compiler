 ...
 * construct reader (aka parser, {@link com.fasterxml.jackson.core.JsonParser})
 * and writer (aka generator, {@link com.fasterxml.jackson.core.JsonGenerator})
 * instances.
 *<p>
        ...
        Serializable // since 2.1 (for Android, mostly)
{
     ...
     * changed for {@link com.fasterxml.jackson.core.JsonFactory}.
     */
    public enum Feature {
     ...
     * to a {@link com.fasterxml.jackson.core.util.BufferRecycler} used to provide a low-cost
    ...
    /**
     * Method for constructing a new {@link com.fasterxml.jackson.core.JsonFactory} that has
     * the same settings as this instance, but is otherwise
     * independent (i.e. nothing is actually shared, symbol tables
     * are separate).
     * Note that {@link com.fasterxml.jackson.core.ObjectCodec} reference is not copied but is
     ...
     * (check {@link com.fasterxml.jackson.core.JsonFactory.Feature} for list of features)
     */
    ...
    /**
     * Method for associating a {@link com.fasterxml.jackson.core.ObjectCodec} (typically
     ...
     * of {@link com.fasterxml.jackson.core.JsonParser} and {@link com.fasterxml.jackson.core.JsonGenerator} instances.
     */
     ...
     * @param f File that contains JSON content to parse
     * 
     * @deprecated Since 2.2, use {@link #createParser(java.io.File)} instead.
     */
    @Deprecated
     ...
     * @param url URL pointing to resource that contains JSON content to parse
     * 
     * @deprecated Since 2.2, use {@link #createParser(java.net.URL)} instead.
     */
    @Deprecated
     ...
     * @param in InputStream to use for reading JSON content to parse
     * 
     * @deprecated Since 2.2, use {@link #createParser(java.io.InputStream)} instead.
     */
    @Deprecated
     ...
     * @param r Reader to use for reading JSON content to parse
     * 
     * @deprecated Since 2.2, use {@link #createParser(java.io.Reader)} instead.
     */
    @Deprecated
     ...
     * {@link com.fasterxml.jackson.core.JsonGenerator#close} is called (unless auto-closing
     * feature,
     ...
     * {@link com.fasterxml.jackson.core.JsonGenerator#close} is called.
     *
     ...
     * @param enc Character encoding to use
     *
     * @deprecated Since 2.2, use {@link #createGenerator(java.io.OutputStream, com.fasterxml.jackson.core.JsonEncoding)} instead.
     */
    @Deprecated
     ...
     * 
     * @deprecated Since 2.2, use {@link #createGenerator(java.io.Writer)} instead.
     */
    @Deprecated
     ...
     * Note: there are formats that use fixed encoding (like most binary data formats).
     * 
     * @deprecated Since 2.2, use {@link #createGenerator(java.io.OutputStream)} instead.
     */
    @Deprecated
     ...
     * @param enc Character encoding to use
     * 
     * @deprecated Since 2.2, use {@link #createGenerator(java.io.File, com.fasterxml.jackson.core.JsonEncoding)} instead.
     */
    @Deprecated
     ...
     * given {@link java.io.InputStream} and context object.
     *<p>
     ...
     * using given {@link java.io.Reader} object for reading content.
     *<p>
     * This method is specifically designed to remain
     * compatible between minor versions so that sub-classes can count
     * on it being called as expected. That is, it is part of official
     ...
     * given {@link java.io.Writer} and context object.
     *<p>
     * This method is specifically designed to remain
     * compatible between minor versions so that sub-classes can count
     * on it being called as expected. That is, it is part of official
    ...
    /**
     * Overridable factory method that actually instantiates generator for
     * given {@link java.io.OutputStream} and context object, using UTF-8 encoding.
     *<p>
     * This method is specifically designed to remain
     * compatible between minor versions so that sub-classes can count
     * on it being called as expected. That is, it is part of official
