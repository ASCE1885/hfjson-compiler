    ...
    implements Serializable // since 2.1
{
     ...
     * creating parser given an {@link java.io.InputStream}, when this decorator
     * has been registered.
     * 
     ...
     * Method can either construct a {@link java.io.InputStream} for reading; or return
     ...
     * 
     * @return Either {@link java.io.InputStream} to use as input source; or null to indicate
    ...
    /**
     * Method called by {@link com.fasterxml.jackson.core.JsonFactory} instance when
     * creating parser given an {@link java.io.Reader}, when this decorator
     * has been registered.
     * 
     * @param ctxt IO context in use (provides access to declared encoding)
     *   NOTE: at this point context may not have all information initialized;
     ...
     *   calls it (for example, a {@link java.io.FilterReader})
     */
