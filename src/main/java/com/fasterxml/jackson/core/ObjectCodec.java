...
/**
 * Abstract class that defines the interface that {@link com.fasterxml.jackson.core.JsonParser} and
 * {@link com.fasterxml.jackson.core.JsonGenerator} use to serialize and deserialize regular
    ...
    implements Versioned // since 2.3
{
     ...
     * using set of {@link com.fasterxml.jackson.core.TreeNode} instances. Returns
    ...
    /**
     * Method for constructing a {@link com.fasterxml.jackson.core.JsonParser} for reading
     ...
     * value type. This is equivalent to first constructing a {@link com.fasterxml.jackson.core.JsonParser} to
     ...
     * ({@link com.fasterxml.jackson.core.JsonFactory}) codec will use for data binding.
     * 
     * @since 2.1
     */
