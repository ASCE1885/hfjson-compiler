    ...
    implements Closeable, Flushable, Versioned
{
    ...
    public enum Feature {
         ...
         * {@link com.fasterxml.jackson.core.JsonToken#START_ARRAY} or {@link com.fasterxml.jackson.core.JsonToken#START_OBJECT}
         ...
         * matching <code>flush()</code> to underlying {@link java.io.OutputStream}
         * or {@link java.io.Writer}; if disabled this will not be done.
         ...
         * duplicates by throwing a {@link com.fasterxml.jackson.core.JsonGenerationException}; if disabled,
         ...
         * if disabled, a {@link com.fasterxml.jackson.core.JsonProcessingException} will be thrown to indicate the
         * problem.
         ...
         * property will result in a {@link com.fasterxml.jackson.core.JsonProcessingException}
         *
         * @since 2.5
         */
     ...
     * check {@link com.fasterxml.jackson.core.JsonGenerator.Feature} for list of available features.
     *
     * @return Generator itself (this), to allow chaining
     */
     ...
     * (check {@link com.fasterxml.jackson.core.JsonGenerator.Feature} for list of features)
     *
     * @return Generator itself (this), to allow chaining
     */
    ...
    /**
     * Bulk access method for getting state of all standard {@link com.fasterxml.jackson.core.JsonGenerator.Feature}s.
     * 
     * @return Bit mask that defines current states of all standard {@link com.fasterxml.jackson.core.JsonGenerator.Feature}s.
     * 
     * @since 2.3
     */
    ...
    /**
     * Bulk set method for (re)setting states of all standard {@link com.fasterxml.jackson.core.JsonGenerator.Feature}s
     * 
     * @since 2.3
     * 
     * @param values Bitmask that defines which {@link com.fasterxml.jackson.core.JsonGenerator.Feature}s are enabled
     *    and which disabled
     *
     ...
     * {@link com.fasterxml.jackson.core.PrettyPrinter}; returns it if so, null if none configured.
     * 
     * @since 2.1
     */
    ...
    /**
     * Method for accessing custom escapes factory uses for {@link com.fasterxml.jackson.core.JsonGenerator}s
     * it creates.
     */
    public CharacterEscapes getCharacterEscapes() { return null; }

    /**
     * Method for defining custom escapes factory uses for {@link com.fasterxml.jackson.core.JsonGenerator}s
     * it creates.
     *<p>
     ...
     * {@link com.fasterxml.jackson.core.SerializableString} which can make this potentially
     ...
     * {@link #writeRaw(com.fasterxml.jackson.core.SerializableString)}.
     * 
     * @since 2.5
     */
     ...
     * linefeeds. However, all {@link com.fasterxml.jackson.core.JsonParser} implementations
    ...
    /**
     * Similar to {@link #writeBinary(com.fasterxml.jackson.core.Base64Variant,byte[],int,int)},
     * but default to using the Jackson default Base64 variant 
     * (which is {@link com.fasterxml.jackson.core.Base64Variants#MIME_NO_LINEFEEDS}).
     */
     ...
     * (which is {@link com.fasterxml.jackson.core.Base64Variants#MIME_NO_LINEFEEDS}). Also
    ...
    /**
     * Similar to {@link #writeBinary(com.fasterxml.jackson.core.Base64Variant, java.io.InputStream,int)},
     * but assumes default to using the Jackson default Base64 variant 
     * (which is {@link com.fasterxml.jackson.core.Base64Variants#MIME_NO_LINEFEEDS}).
     * 
    ...
    /**
     * Method similar to {@link #writeBinary(com.fasterxml.jackson.core.Base64Variant,byte[],int,int)},
     ...
     * a {@link com.fasterxml.jackson.core.JsonGenerationException} will be thrown.
     * 
     * @since 2.3
     */
     ...
     * get copied:
     *<ul>
     * <li>{@link com.fasterxml.jackson.core.JsonToken#START_OBJECT}:
     *   all events up to and including matching (closing)
     *   {@link com.fasterxml.jackson.core.JsonToken#END_OBJECT} will be copied
     *  </li>
     * <li>{@link com.fasterxml.jackson.core.JsonToken#START_ARRAY}
     *   all events up to and including matching (closing)
     *   {@link com.fasterxml.jackson.core.JsonToken#END_ARRAY} will be copied
     *  </li>
     * <li>{@link com.fasterxml.jackson.core.JsonToken#FIELD_NAME} the logical value (which
     ...
     * has feature {@link com.fasterxml.jackson.core.JsonGenerator.Feature#AUTO_CLOSE_TARGET} enabled.
     ...
     * {@link com.fasterxml.jackson.core.JsonGenerationException} with given base message.
     *<p>
     * Note that sub-classes may override this method to add more detail
     * or use a {@link com.fasterxml.jackson.core.JsonGenerationException} sub-class.
     */
