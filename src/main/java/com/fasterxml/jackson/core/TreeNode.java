 ...
 * needed to allow {@link com.fasterxml.jackson.core.ObjectCodec} to have some level
 * of interoperability.
...
public interface TreeNode
{
    ...
    /**
     * If this node is a numeric type (as per {@link com.fasterxml.jackson.core.JsonToken#isNumeric}),
     ...
     *   will return a node for which {@link com.fasterxml.jackson.core.TreeNode#isMissingNode()} returns true.
     * 
     ...
     * {@link com.fasterxml.jackson.core.JsonPointer} instance once and reuse it: this method will not perform
     * any caching of compiled expressions.
     * 
     * @param jsonPointerExpression Expression to compile as a {@link com.fasterxml.jackson.core.JsonPointer}
     *   instance
     * 
     * @return Node that matches given JSON Pointer: if no match exists,
     *   will return a node for which {@link com.fasterxml.jackson.core.TreeNode#isMissingNode()} returns true.
     ...
     * advance it to the first available token by calling {@link com.fasterxml.jackson.core.JsonParser#nextToken()}.
     *<p>
     * Also note that calling this method will <b>NOT</b> pass {@link com.fasterxml.jackson.core.ObjectCodec}
     * reference, so data-binding callback methods like {@link com.fasterxml.jackson.core.JsonParser#readValueAs(Class)}
     * will not work with calling {@link com.fasterxml.jackson.core.JsonParser#setCodec}).
     * It is often better to call {@link #traverse(com.fasterxml.jackson.core.ObjectCodec)} to pass the codec explicitly.
     */
    JsonParser traverse();

    /**
     * Same as {@link #traverse()}, but additionally passes {@link ObjectCodec}
     * to use if {@link com.fasterxml.jackson.core.JsonParser#readValueAs(Class)} is used (otherwise caller must call
     * {@link com.fasterxml.jackson.core.JsonParser#setCodec} on response explicitly).
     *<p>
     * NOTE: constructed parser instance will NOT initially point to a token,
     * so before passing it to deserializers, it is typically necessary to
     * advance it to the first available token by calling {@link com.fasterxml.jackson.core.JsonParser#nextToken()}.
