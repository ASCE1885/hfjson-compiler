 ...
 * a {@link com.fasterxml.jackson.core.JsonFactory} instance.
 *
    ...
    implements Closeable, Versioned
{
    ...
    public enum Feature {
         ...
         * is closed by a call to {@link com.fasterxml.jackson.core.JsonParser#close}.
         *<p>
         ...
         */
         ...
         /**
          * Feature that determines whether {@link com.fasterxml.jackson.core.JsonParser} will explicitly
          ...
          * duplicates by throwing a {@link com.fasterxml.jackson.core.JsonParseException}; if disabled,
    ...
    /**
     * Accessor for {@link com.fasterxml.jackson.core.ObjectCodec} associated with this
    ...
    /**
     * Setter that allows defining {@link com.fasterxml.jackson.core.ObjectCodec} associated with this
     * parser, if any. Codec is used by {@link #readValueAs(Class)}
     * method (and its variants).
     */
     ...
     * {@link java.io.InputStream} or {@link java.io.Reader}, depending on what
     ...
     * {@link com.fasterxml.jackson.core.ObjectCodec} is needed for binding data parsed
     * using {@link com.fasterxml.jackson.core.JsonParser} constructed by this factory
     * (which typically also implies the same for serialization
     * with {@link com.fasterxml.jackson.core.JsonGenerator}).
     * 
     * @return True if custom codec is needed with parsers and
     *   generators created by this factory; false if a general
     *   {@link com.fasterxml.jackson.core.ObjectCodec} is enough
     * 
     * @since 2.1
     */
     ...
     * {@link com.fasterxml.jackson.core.JsonParser.Feature#AUTO_CLOSE_SOURCE} is enabled.
     ...
     *    (that is, input can not be sent to {@link java.io.OutputStream};
     *    otherwise number of bytes released (0 if there was nothing to release)
     *    
     * @throws java.io.IOException if write to stream threw exception
     */    
     ...
     *    (that is, input can not be sent to {@link java.io.Writer};
     *    otherwise number of chars released (0 if there was nothing to release)
     *    
     * @throws java.io.IOException if write using Writer threw exception
     */    
     ...
     * (check {@link com.fasterxml.jackson.core.JsonParser.Feature} for list of features)
     */
    ...
    /**
     * Method for checking whether specified {@link com.fasterxml.jackson.core.JsonParser.Feature} is enabled.
     */
    public boolean isEnabled(Feature f) { return f.enabledIn(_features); }

    /**
     * Bulk access method for getting state of all standard {@link com.fasterxml.jackson.core.JsonParser.Feature}s.
     * 
     * @return Bit mask that defines current states of all standard {@link com.fasterxml.jackson.core.JsonParser.Feature}s.
     * 
     * @since 2.3
     */
    ...
    /**
     * Bulk set method for (re)setting states of all standard {@link com.fasterxml.jackson.core.JsonParser.Feature}s
     *
     * @since 2.3
     * 
     ...
     * and if {@link com.fasterxml.jackson.core.JsonToken#FIELD_NAME} is returned, another
     ...
     *   parsers, {@link com.fasterxml.jackson.core.JsonToken#NOT_AVAILABLE} if no tokens were
     *   available yet)
     */
     ...
     * verifies whether it is {@link com.fasterxml.jackson.core.JsonToken#FIELD_NAME} with specified name
    ...
    /**
     * Method that fetches next token (as if calling {@link #nextToken}) and
     * verifies whether it is {@link com.fasterxml.jackson.core.JsonToken#FIELD_NAME}; if it is,
    ...
    /**
     * Method that fetches next token (as if calling {@link #nextToken}) and
     * if it is {@link com.fasterxml.jackson.core.JsonToken#VALUE_STRING} returns contained String value;
    ...
    /**
     * Method that fetches next token (as if calling {@link #nextToken}) and
     * if it is {@link com.fasterxml.jackson.core.JsonToken#VALUE_NUMBER_INT} returns 32-bit int value;
    ...
    /**
     * Method that fetches next token (as if calling {@link #nextToken}) and
     * if it is {@link com.fasterxml.jackson.core.JsonToken#VALUE_NUMBER_INT} returns 64-bit long value;
     * otherwise returns specified default value
     * It is functionally equivalent to:
     *<pre>
    ...
    /**
     * Method that fetches next token (as if calling {@link #nextToken}) and
     * if it is {@link com.fasterxml.jackson.core.JsonToken#VALUE_TRUE} or {@link com.fasterxml.jackson.core.JsonToken#VALUE_FALSE}
     ...
     * {@link com.fasterxml.jackson.core.JsonToken#START_OBJECT} or {@link com.fasterxml.jackson.core.JsonToken#START_ARRAY}.
     * If not, it will do nothing.
     * After skipping, stream will point to <b>matching</b>
     * {@link com.fasterxml.jackson.core.JsonToken#END_OBJECT} or {@link com.fasterxml.jackson.core.JsonToken#END_ARRAY}
     ...
     * <code>int</code> instead of {@link com.fasterxml.jackson.core.JsonToken} (enum value).
     *<p>
     ...
     * @since 2.3
     * 
     * @return <code>int</code> matching one of constants from {@link com.fasterxml.jackson.core.JsonTokenId}.
     */
     ...
     * the current token: for {@link com.fasterxml.jackson.core.JsonToken#FIELD_NAME}s it will
     ...
     * is {@link com.fasterxml.jackson.core.JsonToken#START_ARRAY}) when start array is expected.
     ...
     *   start-array marker (such {@link com.fasterxml.jackson.core.JsonToken#START_ARRAY});
     *   false if not.
     */
     ...
     * currently points to {@link com.fasterxml.jackson.core.JsonToken#START_OBJECT}.
     * 
     * @since 2.5
     */
     ...
     * {@link com.fasterxml.jackson.core.JsonToken#VALUE_NUMBER_INT} or
     * {@link com.fasterxml.jackson.core.JsonToken#VALUE_NUMBER_FLOAT}, returns
     * one of {@link com.fasterxml.jackson.core.JsonParser.NumberType} constants; otherwise returns null.
     */
    public abstract NumberType getNumberType() throws IOException;

    /**
     * Numeric accessor that can be called when the current
     * token is of type {@link com.fasterxml.jackson.core.JsonToken#VALUE_NUMBER_INT} and
     * it can be expressed as a value of Java byte primitive type.
     * It can also be called for {@link com.fasterxml.jackson.core.JsonToken#VALUE_NUMBER_FLOAT};
     * if so, it is equivalent to calling {@link #getDoubleValue}
     * and then casting; except for possible overflow/underflow
     * exception.
     *<p>
     * Note: if the resulting integer value falls outside range of
     * Java byte, a {@link com.fasterxml.jackson.core.JsonParseException}
     ...
     *<p>
     * Note: if the resulting integer value falls outside range of
     * Java short, a {@link com.fasterxml.jackson.core.JsonParseException}
     * will be thrown to indicate numeric overflow/underflow.
     */
    ...
    /**
     * Numeric accessor that can be called when the current
     * token is of type {@link com.fasterxml.jackson.core.JsonToken#VALUE_NUMBER_FLOAT} and
     * it can be expressed as a Java float primitive type.
     * It can also be called for {@link com.fasterxml.jackson.core.JsonToken#VALUE_NUMBER_INT};
     * if so, it is equivalent to calling {@link #getLongValue}
     * and then casting; except for possible overflow/underflow
     * exception.
     *<p>
     * Note: if the value falls
     * outside of range of Java float, a {@link com.fasterxml.jackson.core.JsonParseException}
     * will be thrown to indicate numeric overflow/underflow.
     */
    ...
    /**
     * Numeric accessor that can be called when the current
     * token is of type {@link com.fasterxml.jackson.core.JsonToken#VALUE_NUMBER_FLOAT} or
     * {@link com.fasterxml.jackson.core.JsonToken#VALUE_NUMBER_INT}. No under/overflow exceptions
     * are ever thrown.
     */
     ...
     * token is {@link com.fasterxml.jackson.core.JsonToken#VALUE_TRUE} or
 ...
 an integer, but its value falls
     ...
     * is {@link com.fasterxml.jackson.core.JsonToken#VALUE_EMBEDDED_OBJECT}. For other token types,
     * null is returned.
     *<p>
     ...
     *   content (see {@link com.fasterxml.jackson.core.Base64Variants} for definitions
    ...
    /**
     * Convenience alternative to {@link #getBinaryValue(com.fasterxml.jackson.core.Base64Variant)}
     * that defaults to using
     * {@link com.fasterxml.jackson.core.Base64Variants#getDefaultVariant} as the default encoding.
     */
     ...
     * of returning content using {@link java.io.OutputStream} instead of as byte array)
     ...
     * 
     * @return Number of bytes that were decoded and written via {@link java.io.OutputStream}
     * 
     * @since 2.1
     */
    ...
    /**
     * Similar to {@link #readBinaryValue(java.io.OutputStream)} but allows explicitly
     ...
     * but not for {@link com.fasterxml.jackson.core.JsonFactory} (unless its <code>setCodec</code>
     * method has been explicitly called).
     *<p>
     * This method may advance the event stream, for structured types
     * the current token will be the closing end marker (END_ARRAY,
     * END_OBJECT) of the bound structure. For non-structured Json types
     * (and for {@link com.fasterxml.jackson.core.JsonToken#VALUE_EMBEDDED_OBJECT})
     ...
     * represented by root {@link com.fasterxml.jackson.core.TreeNode} of resulting model.
    ...
    /**
     * Helper method for constructing {@link com.fasterxml.jackson.core.JsonParseException}s
