...
import com.paic.hyperion.hfjson.typeconverters.DefaultCalendarConverter;
import com.paic.hyperion.hfjson.typeconverters.DefaultDateConverter;
...
public class LoganSquare {
     ...
     */
    @SuppressWarnings("unchecked")
    public static <E> JsonMapper<E> mapperFor(Class<E> cls) throws com.paic.hyperion.hfjson.NoSuchMapperException {
        ...
        if (mapper == null) {
            try {
                ...
                throw new com.paic.hyperion.hfjson.NoSuchMapperException(cls, e);
            }
        }
     ...
     */
    @SuppressWarnings("unchecked")
    public static <E> TypeConverter<E> typeConverterFor(Class<E> cls) throws com.paic.hyperion.hfjson.NoSuchTypeConverterException {
        TypeConverter<E> typeConverter = TYPE_CONVERTERS.get(cls);
        if (typeConverter == null) {
            throw new com.paic.hyperion.hfjson.NoSuchTypeConverterException(cls);
        }
