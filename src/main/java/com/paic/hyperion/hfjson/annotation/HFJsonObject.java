package com.paic.hyperion.hfjson.annotation;
...
public @interface HFJsonObject {
    ...
    public enum FieldDetectionPolicy {
        /** Only parse and serialize fields annotated with @HFJsonField */
        ANNOTATIONS_ONLY,
    ...
    public enum FieldNamingPolicy {
         ...
         * passed into the @HFJsonField annotation
         */
        FIELD_NAME,

        /**
         * Use the Java variable's name converted to lower case separated by
         * underscores, unless the 'name' parameter is passed into the @HFJsonField
         * annotation
         */
     ...
     * serializing. By default, only fields annotated with @HFJsonField will be used.
     */
     ...
     * field's @HFJsonField annotation.
     */
